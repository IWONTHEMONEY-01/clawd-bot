...
import { runNodeDaemonInstall, runNodeDaemonRestart, runNodeDaemonStart, runNodeDaemonStatus, runNodeDaemonStop, runNodeDaemonUninstall, } from "./daemon.js";
...
export function registerNodeCli(program) {
    ...
    const registerNodeServiceCommands = (cmd) => {
        cmd
            .command("status")
