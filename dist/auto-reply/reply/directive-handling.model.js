...
import { buildModelPickerItems, resolveProviderEndpointLabel, } from "./directive-handling.model-picker.js";
...
export async function maybeHandleModelDirectiveInfo(params) {
    ...
    if (wantsList) {
        ...
        const lines = [`Current: ${current}`, "Pick: /model <#> or /model <provider/model>"];
