...
function injectControlUiBasePath(html, basePath) {
    const script = `<script>window.__CLAWDBOT_CONTROL_UI_BASE_PATH__=${JSON.stringify(basePath)};</script>`;
    if (html.includes("__CLAWDBOT_CONTROL_UI_BASE_PATH__"))
        return html;
...
function serveIndexHtml(res, indexPath, basePath) {
