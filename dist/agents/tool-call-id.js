...
export function sanitizeToolCallId(id) {
    ...
    const trimmedInvalidStartChars = cloudCodeAssistPatternReplacement.replace(/^[^a-zA-Z0-9_-]+/, "");
    return trimmedInvalidStartChars.length > 0 ? trimmedInvalidStartChars : "sanitized_tool_id";
}
export function isValidCloudCodeAssistToolId(id) {
    if (!id || typeof id !== "string")
        return false;
...
export function sanitizeToolCallIdsForCloudCodeAssist(messages) {
